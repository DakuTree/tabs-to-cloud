...
importScripts("cloudServices.js");
...
chrome.action.onClicked.addListener(function () {
	saveTabs(function () {
		...
		/**
		 * @deprecated setTimeout can fail in V3 - https://developer.chrome.com/docs/extensions/develop/migrate/to-service-workers#convert-timers
		 *             Our 3s timer shouldn't matter here.
		 */
		setTimeout(function () {
